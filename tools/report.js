...
function renderReport(scoreData, { robotsResult, llmsResult, schemaResult, contentResult, presenceEvidence, context }) {
  ...
  const lines = [
    ...
    url ? `> ${url}` : '',
    '',
    `### GEO Score: ${scoreData.total}/${scoreData.totalMax}${scoreData.presenceUnknown ? ' (presence dimension unknown)' : ''}`,
    ...
    '',
    '---',
    '*Generated by [geo-audit](https://github.com/weiguang8412/geo-audit)*',
  ].filter(l => l !== null);
